...
var after_label: Label3D = null
var silhouette: MeshInstance3D = null
...
func _ready() -> void:
	...
	if(has_node("InteractLabel")):
		after_label = get_node("InteractLabel")
	if(has_node("SillhouetteInstance")):
		silhouette = get_node("SillhouetteInstance")
